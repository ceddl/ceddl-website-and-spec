...
module.exports = function (grunt) {
   ...
   */
  grunt.registerTask('docs', 'Compile ceddl Docs to HTML', function () {
    var done = this.async();
    ...
    function generateDocs(base) {
      ...
      function generateGuides() {
        ...
        // API Docs
        var sidebars = [];
        var names = grunt.file.expand({cwd: base}, ['*.md', '!ceddl*.md', '!README.md']);
      ...
      function generateAPI() {
        ...
        // API Docs
        var sidebars = [];
        var names = grunt.file.expand({cwd: base}, ['ceddl.*.md', '!*utils*']);
